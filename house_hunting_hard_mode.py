...
expected_rate = float(input("Enter the expected annual rate of return:") or "0.04")
down_payment_percent = float(input("Enter the percent of your home's cost to save as a down payment:") or 0.25)
